    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nomor_surat', models.CharField(help_text='Nomor surat resmi (contoh: 001/SM/IV/2026)',
                ...
                ('tanggal_diterima', models.DateTimeField(auto_now_add=True,
                 help_text='Tanggal surat diterima di sistem', verbose_name='Tanggal Diterima')),
                ('file_surat', models.FileField(blank=True, help_text='Upload file surat (PDF, DOCX, atau gambar)',
                 null=True, upload_to='surat_masuk/', verbose_name='File Surat')),
                ('status', models.CharField(choices=[('baru', 'Baru'), ('diproses', 'Diproses'), (
                    'selesai', 'Selesai')], default='baru', help_text='Status pemrosesan surat', max_length=20, verbose_name='Status')),
                ...
                ('dibuat_oleh', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                 related_name='surat_masuk_dibuat', to=settings.AUTH_USER_MODEL, verbose_name='Dibuat Oleh')),
                ('ditugaskan_ke', models.ForeignKey(blank=True, help_text='Staff yang ditugaskan untuk menangani surat ini', null=True,
